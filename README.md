...
GitやPythonに詳しくなくても大丈夫です。ダウンロードから起動まで丁寧に解説したガイドを用意しました:

**[セットアップガイド（初心者向け）](docs/setup-guide-ja.md)**
...
**ダークテーマ**
![LinkStash ダークテーマ](docs/screenshot-dark.png)

**ライトテーマ**
![LinkStash ライトテーマ](docs/screenshot-light.png)
...
**git を使わない場合:**
1. [こちら](https://github.com/MiraQue/LinkStash/archive/refs/heads/master.zip) から ZIP をダウンロード
